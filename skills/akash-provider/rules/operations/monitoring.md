...
| `akash_provider_revenue_uact` | Counter | Total revenue earned (uact) |
...
| Revenue (24h) | Stat | `increase(akash_provider_revenue_uact[24h])` |
    ...
    - name: akash-provider
      rules:
        ...
        - alert: LowWalletBalance
          expr: akash_provider_wallet_balance_uact < 1000000
          for: 5m
          labels:
            severity: critical
          annotations:
