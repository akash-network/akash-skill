...
- **Console Air disambiguation.** The new self-custody UI at `console-air.akash.network` is called out distinctly from the managed-wallet `console.akash.network`.
